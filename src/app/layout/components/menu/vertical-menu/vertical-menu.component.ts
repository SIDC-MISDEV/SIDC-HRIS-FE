...
export class VerticalMenuComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.userValue.username = this._authService.currentUserValue.userName;
    this.userValue.fullname = this._authService.currentUserValue.fullName;
    this.userValue.branchCode = this._authService.currentUserValue.branch;
    this.userValue.warehouse = this._authService.currentUserValue.warehouse;
